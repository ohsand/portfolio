...
const Timeline = () => {
  ...
  return (
    <Section id='about'>
      ...
      <SectionText>
        Junior Web Developer with a passion for design and creativity. I love discovering new things and expanding on my knowledge not only in Web Development but in every thing that I do.
      </SectionText>
